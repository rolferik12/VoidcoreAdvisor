...
L["BONUS_ROLL_CONFIRM_WANTED_ONE"] = "%d wanted item"
L["BONUS_ROLL_CONFIRM_WANTED_MANY"] = "%d wanted items"
...
L["BONUS_ROLL_CONFIRM_NO_SELECTED"] = "No wanted items selected for this spec"

...
L["VAULT_OVERVIEW_STAR_TIP_COUNT"] = "%d wishlist items in this loot pool"
L["VAULT_OVERVIEW_STAR_TIP_VOIDCORE_1"] = "Using a Voidcore here has a higher chance"
L["VAULT_OVERVIEW_STAR_TIP_VOIDCORE_2"] = "of rewarding a desirable item."
L["VAULT_PCT_TIP_ACTIVE_TITLE"] = "Best estimated Voidcore chance"
L["VAULT_PCT_TIP_ACTIVE_1"] = "for this item across all loot specs."
L["VAULT_PCT_TIP_ACTIVE_2"] = "Higher chances usually mean"
L["VAULT_PCT_TIP_ACTIVE_3"] = "fewer remaining loot pool items."
L["VAULT_PCT_TIP_OBTAINED_TITLE"] = "Already obtained."
L["VAULT_PCT_TIP_OBTAINED_1"] =
    "This item is currently excluded from Voidcore bonus rolls until loot protection resets."

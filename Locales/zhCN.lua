...
L["NEBULOUS_VOIDCORE"]			= "晦暗虚空核心"
L["NEBULOUS_VOIDCORES"]			= "晦暗虚空核心"

L["NO_ITEMS_FOR_SPEC"]			= "该专精没有可用物品"
L["LFR_NOT_ELIGIBLE"]			= "在团队查找器模式中不可用"

L["LOOT_SPEC_LABEL"]			= "拾取："
L["ALL_OBTAINED"]				= "✓ 全部"

L["DETECTED_OBTAINED"]			= "已自动检测到 %s 通过晦暗虚空核心获取。"
...
L["REMINDER_SUBTITLE"]			= "优化你的拾取专精以获得晦暗虚空核心奖励！"
L["REMINDER_VOIDCORE_COUNT"]	= "你有 |cffffff00%d|r 个晦暗虚空核心"
...
L["OPTIONS_REMINDER_TOOLTIP"]	= "当进入当前赛季史诗钥石地下城时，如果其他拾取专精能为选定物品提供更好的概率，则显示弹出窗口。"
...
L["RAID_OVERVIEW_NO_DATA"]		= "没有团队战斗数据可用。"
